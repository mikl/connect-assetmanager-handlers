...
var yuiOptimize = function (options, callback) {
...
module.exports.yuiJsOptimize = function (file, path, index, isLast, callback) {
  yuiOptimize({
    'file': file
    , 'type': 'js'
  }, callback);
...
module.exports.yuiCssOptimize = function (file, path, index, isLast, callback) {
  callback(YahooCssMin(file));
};

module.exports.fixVendorPrefixes = function (file, path, index, isLast, callback) {
...
module.exports.uglifyJsOptimize = function (file, path, index, isLast, callback) {
...
module.exports.fixGradients = function (file, path, index, isLast, callback) {
...
module.exports.stripDataUrlsPrefix = function (file, path, index, isLast, callback) {
  callback(file.replace(/data-url/ig,'url'));
};

module.exports.replaceImageRefToBase64 = function (root, verbose) {
  ...
  function getFileData(filePath, stepCallback) {
    ...
    if (filePath.match(/^ *http:\/\//i)) {
      ...
      fs.readFile(root+filePath, stepCallback);
    }
...
module.exports.fixFloatDoubleMargin = function (file, path, index, isLast, callback) {
